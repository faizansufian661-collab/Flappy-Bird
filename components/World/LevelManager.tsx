...
import { GameObject, ObjectType, LANE_WIDTH, SPAWN_DISTANCE, REMOVE_DISTANCE, GameStatus, COLLECTION_COLORS } from '../../types';
...
export const LevelManager: React.FC = () => {
  ...
  useFrame((state, delta) => {
    ...
    // 2. Spawning Logic
    let furthestZ = 0;
    // Only consider static obstacles/gems for gap calculation
    ...
    if (furthestZ > -SPAWN_DISTANCE) {
         ...
         if (isLetterDue) {
             ...
             if (availableIndices.length > 0) {
                 ...
                 const color = COLLECTION_COLORS[chosenIndex];
