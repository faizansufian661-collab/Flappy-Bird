  ...
  if (status === GameStatus.MENU) {
      return (
          <div className="absolute inset-0 flex items-center justify-center z-[100] bg-black/80 backdrop-blur-sm p-4 pointer-events-auto">
              {/* Card Container */}
              <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(255,50,0,0.4)] border border-orange-500/20 animate-in zoom-in-95 duration-500">
                
                {/* Jupiter Theme Cover Art */}
                <div className="relative w-full aspect-video bg-gradient-to-br from-red-900 via-orange-900 to-black overflow-hidden flex flex-col items-center justify-center border-b border-orange-500/20">
                    {/* Decorative Planet CSS - Jupiter Style */}
                    <div className="absolute top-[-40%] right-[-20%] w-[90%] h-[160%] rounded-full bg-orange-600/20 blur-[60px]"></div>
                    <div className="absolute bottom-[-30%] left-[-20%] w-[80%] h-[120%] rounded-full bg-red-600/10 blur-[50px]"></div>
                    
                    {/* Stripes */}
                    <div className="absolute w-[150%] h-[10%] bg-orange-900/30 blur-xl rotate-[-10deg] top-[20%]"></div>
                    <div className="absolute w-[150%] h-[15%] bg-red-900/30 blur-xl rotate-[-12deg] bottom-[20%]"></div>

                    <div className="relative z-10 text-center p-6 flex flex-col items-center">
                        <h1 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 font-cyber drop-shadow-[0_0_20px_rgba(255,69,0,0.6)] leading-tight">
                            RUN TO<br/>JUPITER
                        </h1>
                        <div className="mt-6 px-6 py-2 bg-black/60 backdrop-blur-md border border-orange-500/30 rounded-full inline-block">
                             <p className="text-white text-base md:text-xl font-mono tracking-[0.2em] font-bold text-orange-200 whitespace-nowrap">
                                MADE BY FAIZAN
                            </p>
                        </div>
                    </div>
                 ...
                 <div className="bg-gray-900 p-6 flex flex-col items-center">
                    <button 
                      ...
                      className="w-full group relative px-6 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white font-black text-xl rounded-xl hover:bg-white/20 transition-all shadow-[0_0_20px_rgba(255,140,0,0.4)] hover:shadow-[0_0_30px_rgba(255,140,0,0.6)] hover:border-orange-400 overflow-hidden"
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-orange-600/40 via-red-600/40 to-yellow-600/40 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
                        <span className="relative z-10 tracking-widest flex items-center justify-center">
                            LAUNCH MISSION <Play className="ml-2 w-5 h-5 fill-white" />
                        </span>
                    </button>

                    <p className="text-orange-400/60 text-[10px] md:text-xs font-mono mt-3 tracking-wider uppercase">
                        [ Arrows / Touch to Move ]
                    </p>
                 </div>
              </div>
          </div>
          ...
          <div className="absolute inset-0 bg-black/90 z-[100] text-white pointer-events-auto backdrop-blur-sm overflow-y-auto">
              <div className="flex flex-col items-center justify-center min-h-full py-8 px-4">
                ...
                <button 
                  ...
                  className="px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold text-lg md:text-xl rounded hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,100,0,0.4)]"
                >
                    RUN AGAIN
                </button>
              </div>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-orange-900/90 to-black/95 z-[100] text-white pointer-events-auto backdrop-blur-md overflow-y-auto">
            <div className="flex flex-col items-center justify-center min-h-full py-8 px-4">
                ...
                <p className="text-orange-300 text-sm md:text-2xl font-mono mb-8 tracking-widest text-center">
                    MISSION ACCOMPLISHED BY FAIZAN
                </p>
  ...
  return (
    <>
        <div className={containerClass}>
            ...
            <div className="flex justify-between items-start w-full">
                <div className="flex flex-col">
                    <div className="text-3xl md:text-5xl font-bold text-orange-400 drop-shadow-[0_0_10px_#ff6600] font-cyber">
                ...
                {target.map((char, idx) => {
                    ...
                    return (
                        <div 
                            ...
                            className={`w-6 h-8 md:w-10 md:h-12 flex items-center justify-center border-2 font-black text-sm md:text-xl font-cyber rounded-lg transform transition-all duration-300`}
                        >
                            {char}
                        </div>
                    );
            ...
            {/* Speed Indicator */}
            <div className="w-full flex justify-end items-end pb-12 md:pb-0">
        ...
        {status === GameStatus.PLAYING && (
            <div className="absolute inset-0 pointer-events-none z-[60] flex flex-col justify-end pb-8 px-4 md:hidden">
                <div className="flex justify-between items-end w-full">
                    {/* Left/Right Controls */}
                    <div className="flex gap-4 pointer-events-auto">
                        <button 
                            onPointerDown={(e) => { e.preventDefault(); triggerKey('ArrowLeft'); }}
                            className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20 active:bg-white/30 touch-none"
                        >
                    ...
                    <div className="pointer-events-auto">
                        <button 
                            ...
                            className="w-20 h-20 bg-orange-500/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-orange-400/30 active:bg-orange-500/40 touch-none shadow-[0_0_15px_rgba(255,165,0,0.2)]"
                        >
